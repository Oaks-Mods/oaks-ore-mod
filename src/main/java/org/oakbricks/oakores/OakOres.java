...
public class OakOres implements ModInitializer {
	...
	private static ConfiguredFeature<?, ?> LEAD_ORE_OVERWORLD = Feature.ORE
			.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, BlockClass.LEAD_ORE.getDefaultState(), 8)) /* TODO: Make this configurable */
			.decorate(Decorator.RANGE.configure(new RangeDecoratorConfig(0, 0, 48))) /* TODO: Make this configurable */
			.spreadHorizontally()
	...
	public void onInitialize() {
		...
		RegistryKey<ConfiguredFeature<?, ?>> purpiOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN, new Identifier(MOD_ID, "purpi_ore_overworld"));
		...
		RegistryKey<ConfiguredFeature<?, ?>> leadOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN, new Identifier(MOD_ID, "lead_ore_overworld"));
